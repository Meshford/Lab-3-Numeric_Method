...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->tabControl1->Font = (gcnew System::Drawing::Font(L"Times New Roman", 10.8F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
			...
			this->tabControl1->Size = System::Drawing::Size(1053, 547);
			...
			this->tabPage1->Size = System::Drawing::Size(1045, 514);
			...
			this->groupBox2->Location = System::Drawing::Point(6, 17);
			this->groupBox2->Name = L"groupBox2";
			this->groupBox2->Size = System::Drawing::Size(338, 453);
			this->groupBox2->TabIndex = 17;
			this->groupBox2->TabStop = false;
			this->groupBox2->Text = L"Постановка задачи";
			// 
			// label2
			// 
			...
			this->label5->Font = (gcnew System::Drawing::Font(L"Times New Roman", 12, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(204)));
			this->label5->Location = System::Drawing::Point(6, 215);
			...
			// textBox3
			// 
			this->textBox3->Location = System::Drawing::Point(175, 139);
			...
			this->comboBox2->Location = System::Drawing::Point(133, 213);
			this->comboBox2->Margin = System::Windows::Forms::Padding(3, 2, 3, 2);
			this->comboBox2->Name = L"comboBox2";
			this->comboBox2->Size = System::Drawing::Size(192, 28);
			...
			this->button1->Font = (gcnew System::Drawing::Font(L"Times New Roman", 12, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(204)));
			this->button1->Location = System::Drawing::Point(82, 315);
			...
			this->label3->Size = System::Drawing::Size(164, 22);
			...
			this->label6->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 14, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(204)));
			this->label6->Location = System::Drawing::Point(23, 261);
			...
			this->label7->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 10, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(204)));
			this->label7->Location = System::Drawing::Point(56, 266);
			...
			// textBox1
			// 
			this->textBox1->Location = System::Drawing::Point(72, 261);
			this->textBox1->Margin = System::Windows::Forms::Padding(3, 2, 3, 2);
			this->textBox1->Name = L"textBox1";
			this->textBox1->Size = System::Drawing::Size(72, 28);
			...
			this->label9->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 10, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(204)));
			this->label9->Location = System::Drawing::Point(232, 266);
			...
			this->label8->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 10, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(204)));
			this->label8->Location = System::Drawing::Point(150, 264);
			...
			// zedGraphControl1
			// 
			this->zedGraphControl1->Location = System::Drawing::Point(374, 17);
			...
			this->zedGraphControl1->Size = System::Drawing::Size(661, 453);
			...
			this->tabPage2->Size = System::Drawing::Size(1045, 514);
			...
			this->groupBox1->Size = System::Drawing::Size(256, 384);
			...
			this->button2->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 10, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(204)));
			this->button2->Location = System::Drawing::Point(53, 291);
			...
			this->label11->Font = (gcnew System::Drawing::Font(L"Times New Roman", 12, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(204)));
			this->label11->Location = System::Drawing::Point(6, 231);
			...
			this->comboBox3->Location = System::Drawing::Point(94, 72);
			this->comboBox3->Margin = System::Windows::Forms::Padding(3, 2, 3, 2);
			this->comboBox3->Name = L"comboBox3";
			this->comboBox3->Size = System::Drawing::Size(145, 30);
			...
			this->label10->Font = (gcnew System::Drawing::Font(L"Times New Roman", 12, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(204)));
			this->label10->Location = System::Drawing::Point(6, 72);
			this->label10->Name = L"label10";
			this->label10->Size = System::Drawing::Size(64, 22);
			...
			this->textBox4->Size = System::Drawing::Size(53, 30);
			this->textBox4->TabIndex = 19;
			this->textBox4->Text = L"100";
			// 
			// textBox5
			// 
			this->textBox5->Location = System::Drawing::Point(119, 227);
			this->textBox5->Margin = System::Windows::Forms::Padding(3, 2, 3, 2);
			this->textBox5->Name = L"textBox5";
			this->textBox5->Size = System::Drawing::Size(120, 30);
			...
			this->tabControl2->Font = (gcnew System::Drawing::Font(L"Times New Roman", 10.8F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(204)));
			this->tabControl2->Location = System::Drawing::Point(290, 19);
			this->tabControl2->Margin = System::Windows::Forms::Padding(3, 2, 3, 2);
			this->tabControl2->Name = L"tabControl2";
			this->tabControl2->SelectedIndex = 0;
			this->tabControl2->Size = System::Drawing::Size(626, 393);
			...
			this->tabPage3->Size = System::Drawing::Size(618, 360);
			...
			this->zedGraphControl2->Size = System::Drawing::Size(611, 358);
			...
			this->tabPage4->Size = System::Drawing::Size(618, 360);
			...
			this->zedGraphControl3->Size = System::Drawing::Size(588, 358);
			...
			this->ClientSize = System::Drawing::Size(1054, 548);
...
private:
	...
	double func(double _x) {
		...
		if (number_function == 2) {
			return 1 / (1 + 2 * _x) + cos(10 * _x); 
		}

		if (number_function == 3) {
			return 1 / (1 + 2 * _x) + cos(100 * _x);
		}

	}
	//считает истинное значение интеграла
	double true_value(double a, double b) {
		if (number_function == 1) {
			return log(pow((1 + 2 * b) / (1 + 2 * a), 0.5));
		}

		if (number_function == 2) {
			return (log(1 + 2 * b) - log(1 + 2 * a)) / 2 + (sin(10 * b) - sin(10 * a)) / 10;//тут истинное значение интеграла подводит (должно быть 0.37...)
		}

		if (number_function == 3) {
			return (log(1 + 2 * b) - log(1 + 2 * a)) / 2 + (sin(100 * b) - sin(100 * a)) / 100;
		}
	}
...
private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
	...
	//  Выбор функции
	if (work_function == "1 / (1 + 2 * _x)") {
		number_function = 1;
	}

	if (work_function == "1 / (1 + 2 * _x) + cos(10x)") {
		number_function = 2;
	}

	if (work_function == "1 / (1 + 2 * _x) + cos(100x)") {
		number_function = 3;
	}
...
private:
	...
	int count = 0;
	//функция построения для ЗАДАЧИ 2
private: System::Void button2_Click(System::Object^ sender, System::EventArgs^ e) {
	...
	int max_T = 0;
	//вычисляем рандомные значения для g(x)
	Random(alpha, A, B); 
